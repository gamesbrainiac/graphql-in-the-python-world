...
class Mutations(graphene.ObjectType):
    ...
    create_user = CreateUser.Field(
        description='Creates a new user. Given a username and email.')
    delete_user = DeleteUser.Field(description='Deletes a user. Given the id.')
    create_todo = CreateTodo.Field(
        description='Creates a todo given description and user id')
    delete_todo = DeleteTodo.Field(
        description='Deletes a todo given the id and user.')
